    ...
    addOutput: function(config) {
        var loadStoreTrigger = function(){
            ...
            for(var i=0; i<dataStore.data.items.length; i++){
                ...
                this.output.crops.metadata[fertLbl] = fertMetadata;
        ...
        var MarketPrices = {
            ...
            items:[
                {   // OUTPUT TYPE radiogroup ------------------------------
                    ...
                    columns: 2,
                    items:[
                        {boxLabel: 'Commodity' , name: 'comparisonby', inputValue: 'commodity', checked: true},
                        {boxLabel: 'Region' , name: 'comparisonby', inputValue: 'region'}
                    ]
                }
            ],
            listeners: {
