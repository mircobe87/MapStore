    ...
    handler: function(){
        var getViewParams = function(form){
            ...
            switch(form.currency.getValue()){
                case 'usd': currency = 'market_price_usd'; break;
                case 'pkr': currency = 'market_price_kpr'; break;
                default: currency = 'market_price_usd';
            }
        ...
        Ext.Ajax.request({
            ...
            success: function(result, request){
                ...
                var data = nrl.chartbuilder.marketprces[comparisonby].getData(jsonData, gran_type);
                var charts = nrl.chartbuilder.marketprces[comparisonby].makeChart(data, this.chartOpt, customOpt, this.queryOptions);
